...
class UserSettings(models.Model):
    ...
    interaction_style = models.CharField(
        max_length=20,
        choices=[("gentle", "Gentle"), ("balanced", "Balanced"), ("direct", "Direct")],
        default="balanced",
    )
...
class FinanicalAccounts(models.Model):
    ...
    provider = models.CharField(max_length=30, choices=PROVIDERS, default="unknown")
...
class Category(models.Model):
    ...
    keywords = models.TextField(
        blank=True, help_text="Comma-separated keywords: ארומה, פיצה, קפה"
    )
...
class Transaction(models.Model):
    ...
    classification_type = models.CharField(
        max_length=10, choices=CLASSIFICATION_TYPES, default=AUTO
    )
